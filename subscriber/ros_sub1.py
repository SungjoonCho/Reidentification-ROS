...
class image_converter:
  ...
  def __init__(self):
    self.image_sub = rospy.Subscriber("video/test1",Image,self.callback1)
    self.width1 = 1920
    self.height1 = 1080
    self.fps1 = 25
    self.fourcc1 = cv2.VideoWriter_fourcc(*'DIVX')
    self.out1 = cv2.VideoWriter('output1.mp4', self.fourcc1, self.fps1, (int(self.width1), int(self.height1)))
    self.counter1 = 0    
    self.save_frame1 = './output1'
