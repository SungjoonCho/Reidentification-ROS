...
from detect2 import detect_main
import cv2
########################
...
if opt.use_dense:
    ...
    model_structure = ft_net(opt.nclasses, stride = opt.stride) ## use
...
scipy.io.savemat('./runs2/output2_extract_result.mat',result)